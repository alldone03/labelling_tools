export enum Action {
    ...
    UPDATE_AI_BACKEND_OBJECT_DETECTOR_STATUS = '@@UPDATE_AI_BACKEND_OBJECT_DETECTOR_STATUS',
    ...
    UPDATE_FIX_ZOOM_STATUS = '@@UPDATE_FIX_ZOOM_STATUS',
    UPDATE_MOVE_MODE_STATUS = '@@UPDATE_MOVE_MODE_STATUS',
    ...
    UPDATE_IMAGES_LIST_FILTERS = '@@UPDATE_IMAGES_LIST_FILTERS',
